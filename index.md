...
<section class="kc-home-section">
  <div class="kc-section-heading">
    <div>
      <p class="kc-section-kicker">EXPLORE</p>
      <h2>주요 분류</h2>
    </div>
  ...
  <div class="kc-home-grid">
    ...
    <a class="kc-home-card" href="{{ '/ai/dataset/' | relative_url }}">
      <span class="kc-card-index">04</span>
...
<section class="kc-home-section">
  <div class="kc-section-heading">
    <div>
      <p class="kc-section-kicker">CULTIVARS</p>
      <h2>대표 품종</h2>
    </div>
  </div>
...
<section class="kc-home-section kc-home-final">
  <div class="kc-section-heading">
    <div>
      <p class="kc-section-kicker">DATA FLOW</p>
      <h2>춘란 지식과 AI 데이터를 연결합니다</h2>
    </div>
  </div>
