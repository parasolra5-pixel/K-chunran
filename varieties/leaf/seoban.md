...
layout: default
title: "서반"
permalink: /varieties/leaf/seoban/
---

<section class="kc-leaf-hero kc-jungtu-hero">
  <div>
    <p class="kc-page-kicker">VARIETY CATALOG · LEAF · SEOBAN</p>
    <h1>서반</h1>
    <p class="kc-page-lead">잎에 나타나는 밝은 무늬의 위치와 형태, 경계를 살펴봅니다.</p>
    <p class="kc-page-copy">서반은 잎에서 관찰되는 무늬 형질의 하나입니다. K-Chunran에서는 관찰되는 무늬와 잎의 다른 형질을 분리해 기록합니다.</p>
  </div>
...
<section class="kc-leaf-section">
  <div class="kc-section-heading">
    <div>
      <p class="kc-section-kicker">WHAT IS SEOBAN?</p>
      <h2>서반을 어떻게 볼 것인가</h2>
    </div>
  ...
  <div class="kc-jungtu-observe">
    <div>
      ...
      <span>밝은 무늬가 잎의 어느 부분에 나타나는지 관찰합니다.</span>
    </div>
    <div>
      <strong>형태와 흐름</strong>
      <span>무늬의 모양과 이어지는 방향을 살펴봅니다.</span>
    </div>
    <div>
      <strong>색과 경계</strong>
      <span>무늬와 바탕의 색 대비와 경계의 특징을 기록합니다.</span>
    </div>
    <div>
