...
layout: default
title: "호피반"
permalink: /varieties/leaf/hopiban/
---

<section class="kc-leaf-hero kc-jungtu-hero">
  <div>
    <p class="kc-page-kicker">VARIETY CATALOG · LEAF · HOPIBAN</p>
    <h1>호피반</h1>
    <p class="kc-page-lead">잎에 나타나는 호피 계열 무늬의 형태와 분포를 살펴봅니다.</p>
    <p class="kc-page-copy">호피반은 잎에 나타나는 무늬 형질의 하나입니다. K-Chunran에서는 호피반의 무늬와 잎의 다른 형질, 품종의 대표 분류를 구분해 기록합니다.</p>
  </div>
...
<section class="kc-leaf-section">
  <div class="kc-section-heading">
    <div>
      <p class="kc-section-kicker">WHAT IS HOPIBAN?</p>
      <h2>호피반을 어떻게 볼 것인가</h2>
    </div>
  ...
  <div class="kc-jungtu-observe">
    <div>
      ...
      <span>호피 계열 무늬가 잎에 어떤 모양으로 나타나는지 관찰합니다.</span>
    </div>
    <div>
      <strong>무늬의 분포</strong>
      <span>무늬가 잎의 어느 위치에 나타나며 어떻게 이어지는지 살펴봅니다.</span>
    </div>
    <div>
      <strong>색과 대비</strong>
      <span>무늬의 색과 녹색 바탕의 대비, 농담과 경계를 함께 기록합니다.</span>
    </div>
    <div>
      <strong>다른 잎 형질</strong>
      <span>잎의 형태·자태와 폭 등은 호피반과 별도의 형질 축으로 기록합니다.</span>
    </div>
  </div>
</section>
...
<section class="kc-leaf-section">
  <div class="kc-section-heading">
    <div>
      <p class="kc-section-kicker">HOPIBAN VARIETIES</p>
      <h2>호피반과 연결된 품종</h2>
    </div>
